      ...
      <article style={{
        ...
        <div style={{ display: 'grid', gap: 18 }}>
          <Section title="Who we are">
            ...
            <P>Our website is schoolconnect.co.za</P>
            <P>For questions contact us at hello@schoolconnect.co.za</P>
          </Section>
          ...
          <Section title="How we store your data">
            ...
            <Bullets items={[
              ...
              'Access is controlled by role (parent, teacher, admin)',
          ...
          <Section title="Your rights">
            ...
            <P>To exercise any of these rights contact us at hello@schoolconnect.co.za</P>
          </Section>
          ...
          <Section title="Contact us">
            ...
            <P>Email: hello@schoolconnect.co.za Website: schoolconnect.co.za WhatsApp: [your number]</P>
